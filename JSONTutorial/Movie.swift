...
extension Movie {
    struct Key {
        ...
        static let purchasePriceDict = "im:price"
        static let ituneLinkArray = "link"
    ...
    init?(json: [String: AnyObject]) {
        ...
        let purchasePriceDict = json[Key.purchasePriceDict] as? [String: AnyObject],
        ...
        let priceAmount = purchasePriceAttributes[Key.amount] as? String,
            let priceCurrency = purchasePriceAttributes[Key.currency] as? String else {
                return nil
        }
        self.title = title
